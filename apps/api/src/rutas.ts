...
import { rutasAtenciones } from './modules/atenciones/atenciones.routes.js'
...
import { rutasReportes } from './modules/reportes/reportes.routes.js'
...
export const MODULOS_DE_RUTAS: ModuloDeRutas[] = [
  ...
  { prefijo: '/api/reportes', router: rutasReportes },
